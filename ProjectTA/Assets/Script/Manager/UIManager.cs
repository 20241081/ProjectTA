...
public class UIManager : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        {
            Score_Text.text = "Score : " + Manager_GameScene.Score;  // Score UI 업데이트
            playerHP_Text.text = "HP : " + Manager_GameScene.PlayerHP;   // HP UI업데이트
            Coin_Text.text = "coin : " + (Manager_GameScene.coin_a + gameManager.Instance.nowPlayer.Coin);  // coin UI 업데이트
        }
    }
